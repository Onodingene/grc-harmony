...
const Dashboard = () => {
    ...
    ? [
        {
          ...
          value: String(data.totalControls),
          icon: Shield,
          trend: `${data.controlsDueThisMonth} due this month`,
        },
        {
          label: "Open Issues",
          value: String(data.openIssuesCount),
          icon: AlertTriangle,
          trend: `${data.criticalIssuesCount} critical`,
        },
        {
          label: "Tests Passed",
          value: `${data.passRate}%`,
          icon: CheckCircle,
          trend: `${data.passCount} passed this period`,
        },
        {
          label: "Pending Actions",
          value: String(data.pendingActionsCount),
          icon: Clock,
          trend: `${data.overdueActionsCount} overdue`,
        },
        {
          label: "Active Users",
          value: String(data.activeUsersCount),
          icon: Users,
          trend: `${data.controlOwnersCount} control owners`,
        },
      ]
    : [];
  ...
  const ownerStats = data
    ? [
        {
          label: "Controls Due",
          value: String(data.controlsDueThisMonth),
          icon: Shield,
          trend: `${data.overdueCount} overdue`,
        },
        {
